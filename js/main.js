document.addEventListener('DOMContentLoaded', () => {
    ...
    // --------------------------------------------------------------------------
    // 7. TIMELINE DURATION REMOVED
    // --------------------------------------------------------------------------
    // Duration visuals removed per user request. Markers are static; no JS duration calculations.

    // Add hover/focus handling for accessibility (kept)
